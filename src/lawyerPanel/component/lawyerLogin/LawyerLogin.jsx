  ...
  const LawyerLogin = () => {
    ...
    return (
      <div
        className="min-vh-100 d-flex flex-column p-3"
        style={{
      ...
      >
        <main className=" w-100">
          <Container fluid="lg" className="py-1">
            <Card
              className="border-0 opacity-75 shadow-lg"
            ...
            >
              <Row className="g-0">
                ...
                >
                  ...
                  <Link
                    to="/"
                    className="d-flex align-items-center text-black  bg-white p-3  fw-medium text-decoration-none mb-2"
